          ...
          <div className="services-category" id="residential">
            ...
            <div className="services-grid">
              ...
              <a className="service-card" href="/services/6">
                ...
                <h3>Dishwasher</h3>
                <p>
                  Not cleaning properly, water leaks &amp; drainage problems
                </p>
              </a>
              <a className="service-card" href="/services/7">
                ...
                <h3>Oven</h3>
                <p>
                  Uneven heating, temperature fluctuations &amp; ignition
                  failures
                </p>
              </a>
              <a className="service-card" href="/services/8">
                ...
                <h3>Cooktop</h3>
                <p>
                  Burners not lighting, inconsistent flame &amp; cracked
                  surfaces
                </p>
              </a>
              ...
              <a className="service-card" href="/services/10">
                ...
                <h3>Wine Cooler</h3>
                <p>
                  Temperature inconsistencies, compressor noise &amp;
              ...
              <a className="service-card" href="/services/13">
                ...
                <h3>Stove</h3>
                <p>
                  Burners not heating, gas smell &amp; faulty temperature
                  control
                </p>
              </a>
              <a className="service-card" href="/services/14">
                ...
                <h3>Range</h3>
                <p>
                  Uneven cooking, burner failures &amp; self-clean malfunctions
                </p>
              </a>
            </div>
          </div>
          <div className="services-category" id="commercial">
            ...
            <div className="services-grid">
              <a className="service-card" href="/services/1">
                ...
                <h3>Refrigerator</h3>
                <p>
                  Inconsistent temperatures, compressor failures &amp; excessive
                  energy consumption
                </p>
              </a>
              <a className="service-card" href="/services/15">
                ...
                <h3>Washer</h3>
                <p>
                  Failure to fill, excessive vibration &amp; cycle interruptions
                </p>
              </a>
              <a className="service-card" href="/services/16">
                ...
                <h3>Ice Machine</h3>
                <p>
                  Slow ice production, machine cycling issues &amp; water line
                  blockages
                </p>
              </a>
              ...
              <a className="service-card" href="/services/18">
                ...
                <h3>Dishwasher</h3>
                <p>
                  Poor wash cycles, water temperature failures &amp; drainage
                  clogs
                </p>
              </a>
              <a className="service-card" href="/services/19">
                ...
                <h3>Oven</h3>
                <p>
                  Inconsistent baking temperatures, door seal failures &amp;
              ...
              <a className="service-card" href="/services/21">
                ...
                <h3>Microwave</h3>
                <p>
                  No heat output, door latch failures &amp; power
                  inconsistencies
                </p>
              </a>
              <a className="service-card" href="/services/22">
                ...
                <h3>Wine Cooler</h3>
                <p>
                  Uneven zone temperatures, condenser failures &amp; humidity
                  issues
                </p>
              </a>
              <a className="service-card" href="/services/23">
                ...
                <h3>Freezer</h3>
                <p>
                  Temperature fluctuations, ice buildup &amp; compressor cycling
                  issues
                </p>
              </a>
              <a className="service-card" href="/services/24">
                ...
                <h3>Stove</h3>
                <p>
                  Ignition problems, inconsistent flame &amp; burner blockages
                </p>
              </a>
              ...
              <a className="service-card" href="/services/27">
                ...
                <h3>Range</h3>
                <p>
                  Pilot light failures, uneven heating &amp; gas line issues
                </p>
              </a>
            </div>
          </div>
